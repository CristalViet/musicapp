            ...
            <div class="w-80 mt-5 row  mb-5" >
                ...
                <div class="col-4">
                    <div class="list-group" id="list-tab" role="tablist">
                      ...
                      <a class="list-group-item list-group-item-action {{ $activeTab == 'playlist' ? 'active' : '' }}" id="list-profile-list" data-toggle="list" href="{{route('userPlaylist')}}" aria-controls="profile">Playlist</a>
                      ...
                      <a class="list-group-item list-group-item-action {{ $activeTab == 'favourite' ? 'active' : '' }}" id="list-messages-list" data-toggle="list" href="#list-messages"  aria-controls="messages">My video Favourite</a>
